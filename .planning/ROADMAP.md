...
- A.1 Спроектировать карту как "пространство пути", а не обычную геокарту
- A.2 Добавить базовые зоны карты: дом, работа/учёба, тренировка, фокус, восстановление
- A.3 Добавить точки интереса: пасхалки, скрытые события, редкие задания
- A.4 Связать карту с прогрессом пользователя: выполненные действия открывают новые зоны/детали
- A.5 Подготовить механику "глав" на карте: неделя = отдельный маршрут/глава
...
- C.3 Добавить geo/time verification для заданий с локацией
