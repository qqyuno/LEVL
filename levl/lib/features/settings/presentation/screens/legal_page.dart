  ...
  static const privacy = _LegalDocumentData(
    ...
    sections: [
      _LegalSectionData(
        title: 'Что собираем',
        body:
            'Имя или псевдоним, идентификатор аккаунта, цели, сферы жизни, жизненный контекст, стиль работы, задачи, прогресс, streak, настройки уведомлений, сообщения AI-наставнику и технические события использования приложения.',
      ),
      _LegalSectionData(
        title: 'Зачем это нужно',
        body:
            'Чтобы персонализировать онбординг, генерировать действия на день, сохранять прогресс, синхронизировать данные между устройствами и понимать, где сценарий выполнения требует улучшения.',
      ),
      _LegalSectionData(
        title: 'Как измеряем использование',
        body:
            'LEVL фиксирует только этапы продуктового пути: генерацию, начало, подтверждение или отклонение действия, тип проверки и открытие карты. В аналитику не попадают тексты целей и заданий, заметки, доказательства, фотографии, ссылки и точные координаты.',
      ),
      _LegalSectionData(
      ...
      _LegalSectionData(
        ...
        body:
            'В настройках можно запросить удаление аккаунта. LEVL удалит профиль, задачи, кеш задач, ежедневные отметки, технические события использования и аккаунт авторизации.',
      ),
    ],
  );
